...
openssl req -passin "pass:$pass" -passout "pass:$pass" -key __kafkacat.client.key -new -out __kafkacat.client.req -subj '/CN=kafka/OU=TEST/O=CONFLUENT/L=PaloAlto/S=Ca/C=US'
...
do
	...
	keytool -genkey -noprompt \
				 -alias $i \
				 -dname "CN=kafka, OU=Dev, O=CONFLUENT, L=PaloAlto, S=Ca, C=US" \
